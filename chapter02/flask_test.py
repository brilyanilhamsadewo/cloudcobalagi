...
class FlaskappTests(unittest.TestCase):
    ...
    def test_addusers_status_code(self):
        ...
        # on the specified path
        result = self.app.post('/api/v1/users', data='{ "username":"Ovestint", "emailid": "ronaldrvera@jourrapide.com", "password": "juzahpei6e", "name":"Ronald R. Vera"}', content_type='application/json')
        print (result)
        # assert the status code of the response
    ...
    def test_updusers_status_code(self):
        ...
        # on the specified path
        result = self.app.put('/api/v1/users/3', data='{"username":"Tagning", "emailid": "leolaLguertin@teleworm.us"}', content_type='application/json')
        # assert the status code of the response
